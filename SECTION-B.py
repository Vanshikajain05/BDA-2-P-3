...
train_df = pd.read_csv(r"C:\titanic dataset.csv")
...
for dataset in combine:
    ...
    print(dataset.loc[dataset['age'] > 64, 'age'])
train_df.head()
...
train_OneHotEncoded = one_hot_encoder.fit_transform(train_Embarked)
test_OneHotEncoded = one_hot_encoder.fit_transform(test_Embarked)
